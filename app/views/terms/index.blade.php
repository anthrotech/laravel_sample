...
Exclusions and Limitations</strong></p>
...
<p>This Company's logo is a registered trademark of this Company in the United Kingdom and other countries. The brand names and specific services of this Company featured on this web site are trade marked.</p> 
...
<p style="text-align: right;">&copy; Best Bant <?php echo date("Y"); ?> All Rights Reserved</p>
				<hr class="short">
			</div>
		</div>
	</div>
