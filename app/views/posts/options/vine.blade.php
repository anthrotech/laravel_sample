	...
	<div class="row row-md-h row-lg-h">
		...
		<div class="col-md-4 col-lg-4 col-md-h col-lg-h col-t">
			...
			<div class="submit m-t-xxlg m-b-xxlg">
				...
				{{ Form::open(['route' => 'post-vine', 'files' => true, 'class' => 'm-t']) }}

				{{ Form::hidden('question', $question['id']) }}
				{{ Form::hidden('post_type', 'vine') }}
				...
				<div class="form-group">
					...
					{{ Form::textarea('description', Input::old('description'), ['class' => 'auto-hint', 'rows' => 5, 'title' => 'Submission...']) }}
				</div>
				
				<div class="form-group">
					<strong>VINE (Embed Link):</strong>
